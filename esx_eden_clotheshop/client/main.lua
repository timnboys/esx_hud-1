...
function OpenShopMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu, sklep)
	menu.close()
      if data.current.value == 'shop_clothes' then
			HasPayed = false
			local sklep = true
	TriggerEvent('hud:loadMenu', function(data, menu, sklep)
			local sklep = true
		menu.close()
											...
											if data2.current.value == 'yes' then
												...
												ESX.UI.Menu.Open(
													...
													function(data3, menu3)
														...
														exports['mythic_notify']:DoHudText('error', _U('saved_outfit'))
            ...
            function(data, menu)
              ...
              TriggerEvent('skinchanger:getSkin', function(skin)
                ...
                ESX.TriggerServerCallback('esx_eden_clotheshop:getPlayerOutfit', function(clothes)
				  ...
				  exports['mythic_notify']:DoHudText('error', _U('loaded_outfit'))
				  HasLoadCloth = true
	  ...
	  if data.current.value == 'suppr_cloth' then
		ESX.TriggerServerCallback('esx_eden_clotheshop:getPlayerDressing', function(dressing)
			...
			menu.close()
				...
				exports['mythic_notify']:DoHudText('error', _U('supprimed_cloth'))
